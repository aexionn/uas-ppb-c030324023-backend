@extends('layouts.app')
@section('title', 'Ubah Pendaftaran (Admin)')

@section('content')
<div class="max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-2xl font-bold">Ubah Pendaftaran (Admin)</h1>
        <a href="{{ url('/admin/applications/'.$application->id) }}" class="text-sm text-gray-500 hover:text-blue-600">&larr; Kembali</a>
    </div>

    <div class="bg-white rounded-lg shadow p-6">
        <form method="POST" action="{{ url('/admin/applications/'.$application->id) }}" enctype="multipart/form-data" class="space-y-4">
            @csrf
            @method('PUT')
